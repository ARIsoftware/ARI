...
1. **Module is Already Installed**
   ...
   The module files are located at `/modules/major-projects/`
...
#### `PATCH /api/modules/major-projects/data/[id]`
...
#### `DELETE /api/modules/major-projects/data/[id]`
Delete a project.
...
2. Verify `module_settings` table exists:
   ...
   ```
3. Check API endpoint: `/api/modules/major-projects/settings`

---

### Import Errors

**Symptom:** "Cannot find module '@/modules/major-projects/...'"

**Solution:**
1. Verify module files exist at `/modules/major-projects/`
