...
- `GET /api/modules/shipments/list` - Get all shipments for current user
- `POST /api/modules/shipments/list` - Create a new shipment
- `GET /api/modules/shipments/[id]` - Get a single shipment by ID
- `PATCH /api/modules/shipments/[id]` - Update a shipment
- `DELETE /api/modules/shipments/[id]` - Delete a shipment

### Request/Response Examples

**Create Shipment**
```typescript
POST /api/modules/shipments/list
{
  "shipment": {
    "name": "New Laptop",
...
**Update Shipment**
```typescript
PATCH /api/modules/shipments/[id]
{
  "status": "delivered",
