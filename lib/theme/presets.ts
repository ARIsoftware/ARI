...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  // 5. Evening Light - Light theme with teal topbar
  {
    id: 'evening-light',
    name: 'Evening Light',
    category: 'light',
    colors: {
      ...
      chart4: '280 60% 55%',
      chart5: '45 80% 50%',
      topbarBackground: '199 65% 22%',
      topbarForeground: '0 0% 100%',
      sidebarBackground: '210 40% 98%',
      sidebarForeground: '222 47% 11%',
      sidebarPrimary: '199 65% 22%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '210 40% 96%',
      sidebarAccentForeground: '222 47% 11%',
      sidebarBorder: '214 32% 91%',
      sidebarRing: '199 65% 22%',
      radius: '0.375rem',
    },
  },

  // 6. Rose Quartz - Soft blush pinks with a warm rose accent
  {
    id: 'rose-quartz',
    name: 'Rose Quartz',
    category: 'light',
    colors: {
      background: '350 75% 96.9%',
      foreground: '345 25% 20%',
      card: '340 100% 98.8%',
      cardForeground: '345 25% 20%',
      popover: '340 100% 98.8%',
      popoverForeground: '345 25% 20%',
      primary: '346 60% 58%',
      primaryForeground: '0 0% 100%',
      secondary: '345 65% 92%',
      secondaryForeground: '345 30% 28%',
      muted: '347 60% 93%',
      mutedForeground: '345 20% 46%',
      accent: '346 60% 58%',
      accentForeground: '0 0% 100%',
      destructive: '0 84.2% 60.2%',
      destructiveForeground: '0 0% 98%',
      ...
      chart4: '15 70% 65%',
      chart5: '260 45% 60%',
      sidebarBackground: '344 85% 94.7%',
      sidebarForeground: '345 25% 22%',
      sidebarPrimary: '346 60% 58%',
      sidebarPrimaryForeground: '0 0% 100%',
      sidebarAccent: '345 70% 90%',
      sidebarAccentForeground: '345 30% 20%',
      sidebarBorder: '345 60% 89%',
      sidebarRing: '346 60% 58%',
      radius: '0.625rem',
    },
  },

  // 7. Terminal - Retro mainframe with phosphor green
  {
    id: 'terminal',
    name: 'Terminal',
    category: 'dark',
    colors: {
      background: '0 0% 2%',
      foreground: '134 100% 74.5%',
      card: '0 0% 4%',
      cardForeground: '134 100% 74.5%',
      popover: '0 0% 4%',
      popoverForeground: '134 100% 74.5%',
      primary: '134 100% 74.5%',
      primaryForeground: '0 0% 0%',
      secondary: '120 100% 8%',
      secondaryForeground: '134 100% 74.5%',
      muted: '120 50% 8%',
      ...
      sidebarForeground: '134 100% 74.5%',
      sidebarPrimary: '134 100% 74.5%',
      sidebarPrimaryForeground: '0 0% 0%',
      sidebarAccent: '120 50% 10%',
      sidebarAccentForeground: '134 100% 74.5%',
      sidebarBorder: '120 100% 20%',
      sidebarRing: '134 100% 74.5%',
      radius: '0rem',
    },
  },

  // 7b. Terminal Amber - Retro mainframe with #ff5e1f phosphor orange
  {
    id: 'terminal-amber',
    name: 'Terminal Amber',
    category: 'dark',
    colors: {
      background: '0 0% 2%',
      foreground: '17 100% 56%',
      card: '0 0% 4%',
      cardForeground: '17 100% 56%',
      popover: '0 0% 4%',
      popoverForeground: '17 100% 56%',
      primary: '17 100% 56%',
      primaryForeground: '0 0% 0%',
      secondary: '17 100% 8%',
      secondaryForeground: '17 100% 56%',
      muted: '17 50% 8%',
      mutedForeground: '17 60% 45%',
      accent: '17 100% 56%',
      accentForeground: '0 0% 0%',
      destructive: '0 100% 50%',
      destructiveForeground: '0 0% 0%',
      ...
      chart5: '10 100% 55%',
      sidebarBackground: '0 0% 3%',
      sidebarForeground: '17 100% 56%',
      sidebarPrimary: '17 100% 56%',
      sidebarPrimaryForeground: '0 0% 0%',
      sidebarAccent: '17 50% 10%',
      sidebarAccentForeground: '17 100% 56%',
      sidebarBorder: '17 100% 20%',
      sidebarRing: '17 100% 56%',
      radius: '0rem',
    },
  },
  ...
  // 12. Grayscale - Elegant grays with black highlights and a subtle ruled-paper background
  {
    id: 'grayscale',
    name: 'Grayscale',
    category: 'light',
  ...
  // 13. 8-Bit - Retro gaming aesthetic with sharp corners
  {
    id: '8-bit',
    name: '8-Bit',
    category: 'dark',
