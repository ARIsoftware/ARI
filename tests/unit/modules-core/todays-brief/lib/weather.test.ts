...
// '@/modules/todays-brief/lib/weather-codes' which resolves to the modules-core
// copy under the @/modules/* alias in tsconfig. In vitest the alias is just
// @/ -> repo-root, so we mock the unresolvable path directly.
vi.mock('@/modules/todays-brief/lib/weather-codes', () => ({
...
import { getTemperatureUnit, geocodeCity, fetchDailyWeather, weatherDescription } from '@/modules-core/todays-brief/lib/weather'
