/**
 * Extra coverage for todays-brief/lib/llm-clients.ts
 *
 * Uncovered branches:
...
import { callLLM } from '@/modules-core/todays-brief/lib/llm-clients'
import type { CallLLMOptions } from '@/modules-core/todays-brief/lib/llm-clients'
