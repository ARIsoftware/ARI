...
// ical.ts imports from '@/modules/todays-brief/types' (resolves via @/modules/* alias
// in tsconfig but not in vitest). Mock the type-only import and google helpers.
vi.mock('@/modules/todays-brief/types', () => ({}))

vi.mock('@/modules-core/todays-brief/lib/google', () => ({
...
import { looksLikeIcs, fetchIcsText, fetchTodaysIcalEvents } from '@/modules-core/todays-brief/lib/ical'
