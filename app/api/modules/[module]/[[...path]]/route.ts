...
const MODULE_API_ROUTES: Record<string, Record<string, any>> = {
  ...
  'memento': {
    'settings': () => import('@/modules/memento/api/settings/route'), // GET/POST for user settings
    'milestones': () => import('@/modules/memento/api/milestones/route'), // GET/POST/PATCH/DELETE for milestones
    'eras': () => import('@/modules/memento/api/eras/route') // GET/POST/PATCH/DELETE for eras
  },
  'mail-stream': {
  ...
  'baseball': {
    'teams': () => import('@/modules/baseball/api/teams/route'),
    'teams/[id]': () => import('@/modules/baseball/api/teams/[id]/route'),
    'players': () => import('@/modules/baseball/api/players/route'),
    'players/[id]': () => import('@/modules/baseball/api/players/[id]/route'),
  },
  'backup-manager': {
