...
// Dynamically import Tetris with SSR disabled to avoid "document is not defined" error
              ...
              <div className="mt-8 flex gap-16 tetris-controls-hidden">
                ...
                <div className="flex flex-col items-center">
                  <div className="grid grid-cols-3 gap-1 w-32 h-32">
                    ...
                    <div></div>
                    <button className="tetris-button" onClick={() => controller.moveLeft()}>
                      ←
                    </button>
                    <button className="tetris-button" onClick={() => controller.hardDrop()}>
                      ⏬
                    </button>
                    <button className="tetris-button" onClick={() => controller.moveRight()}>
                      →
                    </button>
                    <div></div>
                    <button className="tetris-button" onClick={() => controller.moveDown()}>
                      ↓
                    </button>
                    <div></div>
                  </div>
                ...
                <div className="flex flex-col justify-center gap-2">
                  <button className="tetris-action-button" onClick={() => controller.flipClockwise()}>
                    ↻
                  </button>
                  <button className="tetris-action-button" onClick={() => controller.flipCounterclockwise()}>
                    ↺
                  </button>
