...
export function MainContentWrapper({ children }: MainContentWrapperProps) {
  ...
  return (
    <div data-tour="main-content" className={`overflow-x-clip ${shouldFade ? "opacity-10 pointer-events-none transition-opacity duration-200" : "transition-opacity duration-200"}`}>
      {children}
    </div>
  )
}
