...
1. Copy the SQL from `/modules-core/ohtani/database/schema.sql`
...
- `GET /api/modules-core/ohtani/data` - Fetch all grid cells
- `PUT /api/modules-core/ohtani/data` - Update a specific cell
