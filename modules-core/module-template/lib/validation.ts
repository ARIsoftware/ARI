...
export const ModuleTemplateEntrySchema = z
  .object({
    id: z.string().uuid(),
    user_id: z.string(),
    message: z.string(),
...
export const EntrySingleResponseSchema = z
  .object({
    entry: ModuleTemplateEntrySchema,
  })
  .openapi('ModuleTemplateEntrySingleResponse')

export const EntryDeleteResponseSchema = z
  .object({
...
export const ModuleTemplateSettingsSchema = z
  .object({
  ...
  .strict()
  .openapi('ModuleTemplateSettings')
