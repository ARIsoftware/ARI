...
DROP TABLE IF EXISTS todays_brief_greetings CASCADE;
DROP TABLE IF EXISTS todays_brief_google_tokens CASCADE;
DROP TABLE IF EXISTS todays_brief_ical_subscriptions CASCADE;

-- Pre-rename table names (module was renamed from morning-brief to
-- todays-brief); present only on installs that never ran the rename migration.
DROP TABLE IF EXISTS morning_brief_greetings CASCADE;
DROP TABLE IF EXISTS morning_brief_google_tokens CASCADE;
DROP TABLE IF EXISTS morning_brief_ical_subscriptions CASCADE;
