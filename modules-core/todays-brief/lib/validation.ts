...
// ─── Settings ───────────────────────────────────────────────────────────────
export const TodaysBriefSettingsSchema = z.object({
...
}).strict().openapi('TodaysBriefSettings')

export const SettingsSavedSchema = z.object({
  success: z.literal(true),
}).openapi('TodaysBriefSettingsSaved')
...
}).openapi('TodaysBriefMeeting')

export const CalendarResponseSchema = z.object({
  connected: z.boolean(),
  events: z.array(BriefMeetingSchema),
  timezone: z.string(),
}).openapi('TodaysBriefCalendar')
...
}).strict().openapi('TodaysBriefTtsRequest')
...
}).openapi('TodaysBriefGoogleStatus')

export const GoogleDisconnectResponseSchema = z.object({
  success: z.literal(true),
}).openapi('TodaysBriefGoogleDisconnect')
