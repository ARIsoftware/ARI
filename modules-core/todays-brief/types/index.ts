/**
 * Today's Brief Module - Type Definitions
 *
 * Keep in sync with:
...
export interface TodaysBriefSettings {
...
/** A selectable ElevenLabs voice, as surfaced by GET /api/modules/todays-brief/voices. */
...
/** Response from GET /api/modules/todays-brief/voices */
...
/** Response from GET /api/modules/todays-brief/greeting */
...
/** Response from GET /api/modules/todays-brief/calendar */
...
/** Response from GET /api/modules/todays-brief/weather */
...
/** Response from GET /api/modules/todays-brief/google/status */
...
/** Response from GET /api/modules/todays-brief/ical/status */
