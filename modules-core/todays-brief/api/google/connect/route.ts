/**
 * Today's Brief Module - Google OAuth: start
 *
 * GET /api/modules/todays-brief/google/connect
 *
...
import { getGoogleConfig, buildAuthUrl, OAUTH_STATE_COOKIE } from '@/modules/todays-brief/lib/google'
...
registry.registerPath({
  method: 'get',
  path: '/api/modules/todays-brief/google/connect',
  operationId: 'startTodaysBriefGoogleOAuth',
