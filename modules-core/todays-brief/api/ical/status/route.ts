/**
 * Today's Brief Module - iCal subscription status
 *
 * GET /api/modules/todays-brief/ical/status
 *
...
import { IcalStatusResponseSchema } from '@/modules/todays-brief/lib/validation'
...
registry.registerPath({
  method: 'get',
  path: '/api/modules/todays-brief/ical/status',
  operationId: 'getTodaysBriefIcalStatus',
...
export async function GET() {
  try {
    ...
    console.error('GET /api/modules/todays-brief/ical/status error:', error instanceof Error ? error.message : error)
