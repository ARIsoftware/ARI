...
export function TodaysBriefOnboarding({ googleConnected, aiReady }: OnboardingProps) {
  return (
    <div className="p-6 max-w-lg mx-auto">
      <Card>
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">Welcome to Today&apos;s Brief</CardTitle>
          <CardDescription>
            Each morning, Today&apos;s Brief writes you a one-page, printable rundown of your day —
