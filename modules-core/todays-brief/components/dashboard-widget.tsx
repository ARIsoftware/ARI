...
import { useBriefData } from '@/modules/todays-brief/hooks/use-brief-data'
import { BriefView } from './brief-view'

/**
 * Dashboard widget for Today's Brief — renders the FULL brief (greeting,
 ...
 */
export default function TodaysBriefDashboardWidget() {
    ...
    return (
      <Card>
        <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
          ...
          <div>
            <p className="font-medium">Today&apos;s Brief</p>
            <p className="mt-1 text-sm text-muted-foreground">
              Choose an AI provider to see your brief here.
            </p>
          </div>
          <Button asChild size="sm">
            <Link href="/todays-brief/settings">
              Set up
