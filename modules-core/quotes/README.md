...
const MODULE_PAGES: Record<string, any> = {
  // ... other modules
  'quotes': () => import('@/modules-core/quotes/app/page')
}
```
...
### GET /api/modules-core/quotes/quotes
...
### POST /api/modules-core/quotes/quotes
Create a new quote.
...
### PUT /api/modules-core/quotes/quotes
...
### DELETE /api/modules-core/quotes/quotes?id={uuid}
...
### GET /api/modules-core/quotes/settings
...
### PUT /api/modules-core/quotes/settings
