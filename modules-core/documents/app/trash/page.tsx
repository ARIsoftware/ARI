...
import { getFileIcon, formatFileSize, formatDate, toastError } from '../../lib/utils'
...
export default function DocumentsTrashPage() {
  ...
  const handleRestore = async (id: string) => {
    try {
      ...
      toastError(toast, 'Restore failed', error)
    }
  }
  ...
  const handleEmptyTrash = async () => {
    try {
      ...
      toastError(toast, 'Failed to empty trash', error)
    }
  }
