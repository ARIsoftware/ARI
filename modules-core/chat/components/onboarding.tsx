      ...
      <div className="relative overflow-hidden rounded-3xl border bg-card shadow-sm">
        ...
        <div className="space-y-6 px-8 pb-8">
          ...
          <div className="rounded-xl border border-accent/20 bg-accent/5 p-4">
            <p className="mb-2.5 text-base font-medium">Two steps to your first chat</p>
            <ol className="space-y-2.5 text-base text-muted-foreground">
              <li className="flex gap-3">
                <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-accent text-xs font-semibold text-accent-foreground">1</span>
                <span>
                  Add an API key in{' '}
              ...
              <li className="flex gap-3">
                <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-accent text-xs font-semibold text-accent-foreground">2</span>
                <span>
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            ...
            <Button
              size="lg"
              className="flex-1 bg-gradient-to-br from-accent to-accent/80 text-base text-accent-foreground hover:opacity-90"
              onClick={onComplete}
              disabled={isPending}
            >
              {isPending ? (
